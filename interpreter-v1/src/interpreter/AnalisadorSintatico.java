...
public class AnalisadorSintatico {
	...
	public void addErro(String erro) {
		erros.add("Erro sintático: " + erro + ". " + "Linha: " + token.getLinha() + ", coluna: " + token.getColuna());
	}
	...
	private No cmdInter() {
		...
		if (token.getImagem().equals("int") || token.getImagem().equals("real") || token.getImagem().equals("texto")
			...
			addErro("Erro: esperado 'int' ou 'real' ou 'texto' ou 'logico' ou '=' ou 'enquanto' ou 'se' ou 'mostra' ou 'le'");
		}
		return no;
	}
	...
	private No tipo() {
		...
		if (token.getImagem().equals("int")) {
			...
			addErro("Erro: esperado 'int' ou 'real' ou 'texto' ou 'logico'");
		}
		return no;
	}
	...
	private No laco() {
		...
		if (token.getImagem().equals("enquanto")) {
			...
			addErro("Erro: esperado 'enquanto'");
		}
		return no;
	}
	...
	private No expRel() {
		...
		if (token.getImagem().equals(">") || token.getImagem().equals("<") || token.getImagem().equals(">=")
			...
			addErro("Erro: esperado Operador Lógico ou Relacional");
		}
		return no;
	}
	...
	private No opRel() {
		...
		if (token.getImagem().equals(">")) {
			...
			addErro("Erro: esperado '>' ou '<' ou '>=' ou '<=' ou '==' ou '!='");
		}
		return no;
	}
	...
	private No expArit() {
		...
		if (token.getClasse().equals("ID") || token.getClasse().equals("CLI") || token.getClasse().equals("CLR")
			...
			addErro("Erro: esperado 'id' ou 'cli' ou 'clr' ou 'cls' ou '{'");
		}
		return no;
	}
	...
	private No opArit() {
		...
		if (token.getImagem().equals("+")) {
			...
			addErro("Erro: esperado '+' ou '-' ou '*' ou '/' ou '.'");
		}
		return no;
	}
	...
	private No operan() {
		...
		if (token.getClasse().equals("ID")) {
			...
			addErro("Erro: esperado 'id' ou 'cli' ou 'clr' ou 'cls'");
		}
		return no;
	}
